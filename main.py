...
dict = scraper.scrape_lecture_page('https://mediaspace.wisc.edu/media/Tyler%20Caraza-Harter-Noland%20132-09_06_23-13%3A09%3A04/1_1mzmx981')
print(dict['file_name'])
print(dict['date'])
print(dict['embed_link'])
